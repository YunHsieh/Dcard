...
import notFoundImage from 'image/notFound.jpg'
import Button from 'react-bootstrap/Button'
import 'css/scenicSpot.css'
...
class ScenicSpot extends React.Component{
    ...
    openDetail = () => ScenicSpotDetail.open(this.props.spot, this.props.spot.Picture.PictureUrl1, this.props.spot.Picture.PictureDescription1)
